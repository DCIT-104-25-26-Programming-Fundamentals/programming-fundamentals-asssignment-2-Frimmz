...
void displayAllStudents(const vector<Student>& students) {
    ...
    for (const auto& student : students) {
        ...
        // Align average column nicely
        cout << fixed << setprecision(2) << " -> Avg: " << computeAverage(student.scores) << endl;
    }
    cout << "-------------------------------------------------------------" << endl;
}

// Function to calculate and print average score for a specific student ID
    ...
    while (choice != 4) {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                break;
            default:
                cout << "Invalid choice. Please choose options 1 through 4." << endl;
                break;
        }
    }
